  ...
  const columns = [
    {
      ...
      renderCell: (_value, _onChange, rowIndex) => (
        <div
          className="w-4 h-4 rounded-full bg-white border-2 border-blue-900 mx-auto"
        />
      ),
    },
    {
    ...
    },
    {
      ...
      renderCell: (value, onChange) => (
        <InputField type="date" value={value} onChange={(e) => onChange(e.target.value)} />
      ),
    },
    {
      key: "poblacion",
        ...
        <DynamicTable
          ...
          renderExpandedRow={(idx) => (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <InputField value="juan@mail.com" label="Correo electrónico" onChange={() => {}} />
