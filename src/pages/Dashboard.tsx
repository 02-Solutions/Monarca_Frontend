  ...
  return (
    <div className="grid grid-cols-4 gap-y-20 py-10 px-1 ml-0">
      ...
      {authState.userPermissions.includes("approve_request" as Permission) && (
        <Mosaic title="Viajes por aprobar" iconPath="/assets/viajes_por_aprobar.png" link=""/>
      )}
      ...
      {authState.userPermissions.includes("view_assigned_requests_readonly" as Permission) && (
        <Mosaic title="Historial de viajes aprobados" iconPath="/assets/historial_de_viajes_aprobados.png" link=""/>
      )}
      ...
      {authState.userPermissions.includes("approve_request" as Permission) && (
        <Mosaic title="Viajes por reservar" iconPath="/assets/viajes_por_reservar.png" link=""/>
      )}
      ...
      {authState.userPermissions.includes("view_assigned_requests_readonly" as Permission) && (
        <Mosaic title="Historial de viajes reservados" iconPath="/assets/historial_de_viajes_reservados.png" link=""/>
      )}
    </div>
  );
};
